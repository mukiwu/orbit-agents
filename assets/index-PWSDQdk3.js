...
function WelcomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#F8F7F6] flex flex-col relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative z-10 pt-20 pb-16 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-blue-700 text-sm font-medium mb-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative z-10 py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-500 text-center mb-16 max-w-xl mx-auto", children: "No complex setup, no steep learning curve." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative z-10 py-24 bg-white/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-gray-900 text-center mb-4 font-display", children: "Why Orbit?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-500 text-center mb-16 max-w-xl mx-auto", children: "See how Orbit compares to traditional automation platforms." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-2xl ring-1 ring-gray-900/5 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full min-w-[500px] text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-gray-50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", "aria-label": "Feature", className: "px-6 py-4 text-sm font-semibold text-gray-500 uppercase tracking-wider w-1/4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", className: "px-6 py-4 text-sm font-semibold text-gray-500 uppercase tracking-wider", children: "n8n / Zapier / Others" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative z-10 py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-gray-900 text-center mb-4 font-display", children: "Key Features" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-500 text-center mb-16 max-w-xl mx-auto", children: "Everything you need to automate AI tasks on your desktop." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative z-10 py-20 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-500 mb-10", children: "Free, open source, no signup required." }),
